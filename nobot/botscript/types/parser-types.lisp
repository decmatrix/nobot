...
(defparameter *botscript-sort-types*
  (define-types 
    ...
    (:value "save-to-expr" :description "'save to' expression")
    ...
    (:value "literal-or-id-or-input" :description "literal, id or keyword ?input")
    ...
    (:value "gotov-arg" :description "'go to' expression arg: id or keyword self")
    ))
